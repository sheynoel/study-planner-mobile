...
test('all task sorting options are deterministic and keep undated tasks after dated tasks', () => {
  const records = [
    task('Beta', { priority: 'LOW', createdAt: '2026-08-01T00:00:00.000Z', dueAt: '2026-08-07T12:00:00' }),
    task('Alpha', { priority: 'HIGH', createdAt: '2026-08-03T00:00:00.000Z', dueAt: '2026-08-06T12:00:00' }),
