...
const styles = StyleSheet.create({ card: { alignItems: 'center', alignSelf: 'stretch', flexDirection: 'row', gap: DesignTokens.spacing.sm, minHeight: 60, padding: DesignTokens.spacing.sm, width: '100%' }, icon: { alignItems: 'center', borderRadius: DesignTokens.radius.md, height: 36, justifyContent: 'center', width: 36 }, title: { flex: 1, fontSize: 12, fontWeight: '800', lineHeight: 16 } });
