...
const styles = StyleSheet.create({ container: { borderRadius: DesignTokens.radius.lg, flexDirection: 'row', gap: 2, marginHorizontal: DesignTokens.layout.screenPadding, padding: DesignTokens.spacing.xs }, day: { alignItems: 'center', borderRadius: DesignTokens.radius.md, flex: 1, gap: 1, minHeight: 48, justifyContent: 'center' }, weekday: { fontSize: 10, lineHeight: 13 } });
