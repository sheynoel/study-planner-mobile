...
const styles = StyleSheet.create({ container: { flexDirection: 'row', gap: DesignTokens.spacing.md, minHeight: 84 }, rail: { alignItems: 'center', width: 28 }, dot: { alignItems: 'center', borderRadius: DesignTokens.radius.pill, height: 28, justifyContent: 'center', width: 28, zIndex: 2 }, line: { bottom: -8, opacity: 0.5, position: 'absolute', top: 28, width: StyleSheet.hairlineWidth }, content: { borderRadius: DesignTokens.radius.lg, flex: 1, gap: DesignTokens.spacing.xs, marginBottom: DesignTokens.spacing.sm, padding: DesignTokens.spacing.md }, heading: { alignItems: 'flex-start', flexDirection: 'row', gap: DesignTokens.spacing.sm }, title: { flex: 1 }, time: { ...DesignTokens.typography.caption }, pressed: { opacity: 0.72 } });
