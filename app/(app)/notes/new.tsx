...
export default function AddNoteScreen() {
  ...
  return <AppBottomSheet expandable expandedSnap={0.96} initialSnap={0.68} modal={false} onClose={close} title="Add Note">
    ...
    {listStatus === 'success' ? <NoteForm courses={courses} initialValues={createNoteForm(courseId ?? null)} loadingLabel="Saving…" lockCourse={Boolean(courseId)} onDirtyChange={setDirty} onSubmit={handleCreate} onSubmittingChange={setSubmitting} submitLabel="Save" /> : null}
  </AppBottomSheet>;
}
