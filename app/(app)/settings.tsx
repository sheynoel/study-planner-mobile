...
export default function SettingsScreen() {
  ...
  return <AppScreen footer={<AppSectionTabs active="settings" />}>
    ...
    <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      <SettingSection label="ACADEMIC CALENDAR"><SettingGroup><SettingsRow description="Active term and no-class dates" divider grouped icon="calendar-outline" label="Semesters" onPress={() => router.push('/semesters')} /><SettingsRow description="Archived course history" grouped icon="archive-outline" label="Previous Courses" onPress={() => router.push('/previous-courses')} /></SettingGroup></SettingSection>
