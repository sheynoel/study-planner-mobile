...
- Add Course may optionally collect several meeting forms and create those same schedule records sequentially after Course creation. A failed later meeting never rolls back or hides the confirmed Course; the UI reports the partial count and opens the course schedule manager for recovery.
